...
<table width="1655" height="1535" border="0" align="center">
  <tr>
    ...
    <p><form id="form1" name="form1" method="post" action="neg_registro.php">
        <table width="436" height="826" border="1" align="center">
          <tr>
            <td height="39" colspan="2" bgcolor="#CCCCCC"><center>
              <span class="Estilo2"> DATOS PERSONALES </span>
            </center></td>
          </tr>
          <tr>
            <td width="148" height="90" bgcolor="#CCCCCC"><span class="Estilo2">Genero</span></td>
            <td width="272" bgcolor="#CCCCCC"><p> <span class="Estilo2">
              <label>
                <input type="radio" name="genero" value="femenino" id="RadioGroup2_0" />
                Femenino</label>
              <br />
              <label>
                <input type="radio" name="genero" value="masculino" id="RadioGroup2_1" />
                Masculino</label>
              <br />
              <label>
                <input type="radio" name="genero" value="otro" id="RadioGroup2_2" />
                Otro</label>
              <br />
              <br />
            </span></p></td>
          ...
          <tr>
            <td height="31" bgcolor="#CCCCCC" class="Estilo2">Nombres</td>
            <td bgcolor="#CCCCCC"><span class="Estilo2">
              <input type="text" name="nombres" placeholder="Dijite sus nombres completos" id="textfield3" required="required" />
            </span></td>
          </tr>
          <tr>
            <td height="27" bgcolor="#CCCCCC" class="Estilo2">Fecha de Nacimiento</td>
            <td bgcolor="#CCCCCC"><span class="Estilo2">
              <input name="fecha_de_nacimiento" type="date" id="fecha_de_nacimiento" value="" required="required" />
            </span></td>
          </tr>
          <tr>
            <td height="33" bgcolor="#CCCCCC" class="Estilo2">Correo Electronico</td>
            <td bgcolor="#CCCCCC"><span class="Estilo2">
              <input type="text" name="correo_electronico" placeholder="Dijite su correo"id="textfield4" required="required" />
            </span></td>
          </tr>
          <tr>
            <td height="54" bgcolor="#CCCCCC"><span class="Estilo2">Pais</span></td>
            <td bgcolor="#CCCCCC"><span class="Estilo2">
          ...
          <tr>
            <td height="23" rowspan="2" bgcolor="#CCCCCC"><span class="Estilo2">Departamento</span></td>
            <td height="32" bgcolor="#CCCCCC" class="box" id="ddlDeptoMunicipio_dlpMunicipiostdPanel" style="cursor:hand" onclick="javascript:searchPanel(this, 'ddlDeptoMunicipio_dlpMunicipiosPanel');"><span class="Estilo2">Buscar..</span></td>
          </tr>
          <tr>
            <td height="26" bgcolor="#CCCCCC" class="box" id="ddlDeptoMunicipio_dlpMunicipiostdPanel" style="cursor:hand" onclick="javascript:searchPanel(this, 'ddlDeptoMunicipio_dlpMunicipiosPanel');"><span class="box" style="cursor:hand"><span class="box" style="cursor:hand"><span class="Estilo2">
          ...
          <tr>
            <td height="25" bgcolor="#CCCCCC"><span class="Estilo2">Telefono</span></td>
            <td bgcolor="#CCCCCC"><span class="Estilo2">
              <input onkeypress="return acceptCharDir(event);" name="telefono" placeholder="Dijite su numero telefonico" type="text" maxlength="30" id="telefono" title="Teléfono" class="box" style="width:250px;" />
            </span></td>
          </tr>
          <tr>
            <td height="29" bgcolor="#CCCCCC"><span class="Estilo2">Ocupacion</span></td>
            <td bgcolor="#CCCCCC"><span class="Estilo2">
          ...
          <tr>
            <td height="31" bgcolor="#CCCCCC"><span class="Estilo2">Temas de Interes</span></td>
            <td bgcolor="#CCCCCC"><span class="Estilo2">
          ...
          <tr>
            <td height="144" bgcolor="#CCCCCC"><span class="Estilo2">Desea recibir periódicamente información de las novedades de la biblioteca en sus temas de interés?</span></td>
            <td bgcolor="#CCCCCC"><p> <span class="Estilo2">
              <label>
                <input type="radio" name="novedades" value="si" id="RadioGroup1_0" />
                Si</label>
              <br />
              <label>
                <input type="radio" name="novedades" value="no" id="RadioGroup1_1" />
                No</label>
              <br />
              <br />
            </span></p></td>
          ...
          <tr>
            <td height="3" colspan="2" bgcolor="#CCCCCC"><p><span class="Estilo2">Datos de Usuario</span></p></td>
          </tr>
          <tr>
            <td height="1" bgcolor="#CCCCCC"><span class="Estilo2">Tipo de Documento</span></td>
            <td bgcolor="#CCCCCC"><span class="Estilo2">
              <select name="tipo_de_documento" size="1" onclick="javascript:hideShowCtrl()" id="tipo_de_documento" title="Tipo de documento">
          ...
          <tr>
            <td height="2" bgcolor="#CCCCCC"><span class="Estilo2">Numero de Documento</span></td>
            <td bgcolor="#CCCCCC"><span class="Estilo2">
              <input type="text" name="numero_de_documento" placeholder="Dijite el numero de su documento" maxlength="13" size="28" value="" id="numero_de_documento" title="Numero de documento" class="input_blanco_obligatorio" />
            </span></td>
          </tr>
          <tr>
            <td height="11" bgcolor="#CCCCCC"><span class="Estilo2">Contraseña</span></td>
            <td bgcolor="#CCCCCC"><span class="Estilo2">
              <input onkeypress="return acceptChar(event);" name="contrasena" placeholder="Dijite su contraseña" type="password" maxlength="8" id="contrasena" title="Contraseña" class="box" style="width:160px;" />
            </span></td>
          </tr>
          <tr>
            <td height="40" bgcolor="#CCCCCC">&nbsp;</td>
            <td bgcolor="#CCCCCC"><span class="Estilo2">
              <input onkeypress="return acceptChar(event);" name="confirmar_contrasena" placeholder="nuevamente dijite su contraseña" type="password" maxlength="8" id="confirmar_contrasena" title="Confirmar Contraseña" class="box" style="width:160px;" />
            </span></td>
          </tr>
        </table>
        <p>
          <center><input name="registrar" type="submit" class="Estilo2" id="registrar" value="REGISTRAR" /></center>
          <center><input name="cerrar" type="submit" class="Estilo2" id="cerrar" value="Cerrar" /></center>
        </p>
      </form></p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
