...
<table width="1500" height="590" border="0" align="center"  >
  <tr align="center" valign="top">
    <td height="194" colspan="4" ><iframe src="banner2.php" align="center" frameborder="0" scrolling="no" width="1902" height="185"> </iframe></td>
  </tr>
  <tr>
    <td width="621" height="280" align="center" valign="middle">
    ...
    <td width="510" align="center" valign="middle">&nbsp;</td>
    <td width="772" height="280" align="center" valign="middle"> <p><?php
	include('conexion.php');  

$busqueda=$_POST["nombre"];


$sql="SELECT * FROM libro WHERE idLibro='$busqueda'";
...
$sql2="SELECT * FROM estadoprestamo WHERE idEstadoPrestamo='$ffk_id_EstadoPrestamo'";
	...
	echo"<table width=631 height=264 border=1 align=right>";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 $sql="SELECT * FROM libro WHERE titulo LIKE '$busqueda%'";
...
echo"</table>";
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$sql="SELECT * FROM libro WHERE autor LIKE '$busqueda%'";
...
$sql="SELECT * FROM libro WHERE editorial LIKE '$busqueda%'";
...
echo"</table>";
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$sql="SELECT * FROM libro WHERE genero LIKE '$busqueda%'";
...
echo"</table>";	
  ...
  <tr align="center" valign="top">
    <td height="102" colspan="4" valign="bottom"> <iframe src="footer.php" align="center" frameborder="0" scrolling="no" width="1902" height="200"></iframe></td>
  </tr>
</table>
