...
<table width="1500" height="917" border="0" align="center" >
  ...
  <tr>
	...
	<center>
	  <form id="form1" name="form1" method="post" action="neg_eliminarLibro.php">
	    <table width="326" height="58" border="0" align="center">
          <tr>
            <td width="304" align="center" valign="middle" class="Estilo1 Estilo5 Estilo6">ELIMINAR LIBRO</td>
          </tr>
        </table>
	    <p>CODIGO DEL LIBRO <br />
