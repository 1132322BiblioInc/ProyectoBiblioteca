...
<table width="1500" height="917" border="0" align="center" >
  ...
  <tr>
   ...
   $sql1="SELECT * FROM prestamo WHERE documento_usuario='$ddocu'";
	...
	{ 
      ...
      echo"<td width=144 bgcolor=#569EAB>$iid_prestamo</td>";
      ...
      echo"<td bgcolor=#569EAB><label for=textfield2></label> $ccodigo_libro</td>";
      echo"<td class=Estilo2 bgcolor=#569EAB>TITULO DEL LIBRO</td>";
      echo"<td bgcolor=#569EAB><label for=textfield3></label>$ttitulo_libro</td>";
      echo"</tr>";
      echo"<tr>";
      echo"<td class=Estilo2 bgcolor=#569EAB>DOCUMENTO USUARIO</td>";
      echo"<td bgcolor=#569EAB><label for=textfield5></label>$ddocumento_usuario</td>";
           
      echo"<td class=Estilo2 bgcolor=#569EAB>NOMBRE USUARIO</td>";
      echo"<td bgcolor=#569EAB><label for=textfield5></label>$nnombre_usuario</td>";
      echo"</tr>";
      echo"<tr>";
      echo"<td class=Estilo2 bgcolor=#569EAB>FECHA DE PRESTAMO</td>";
      echo"<td bgcolor=#569EAB><label for=textfield6></label> $ffecha_prestamo</td>";
      echo"<td class=Estilo2 bgcolor=#569EAB>FECHA ENTREGA</td>";
      echo"<td bgcolor=#569EAB><label for=textfield7></label>$ffecha_entrega</td>";
      echo"</tr>";
      echo"<tr bgcolor=#067184>";
