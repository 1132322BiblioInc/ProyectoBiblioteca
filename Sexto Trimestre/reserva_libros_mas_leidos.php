...
<table width="1500" height="739" border="0" align="center" >
  <tr align="center" valign="top">
    <td height="283" colspan="3" > <iframe src="banner2.php" align="center" frameborder="0" scrolling="no" width="1902" height="185"> </iframe>
      <div id="apDiv2"><img src="imagenes/n.jpg" width="208" height="150" /></div>
      <div id="apDiv1"><img src="imagenes/bienvenidos.jpg" width="214" height="164" /></div></td>
  </tr>
  <tr align="center" valign="top">
  ...
  <tr>
    <td width="597" height="223" align="center" valign="middle">
  ...
  <!----------------------------------------------------------------------------------------------------------------->  
    ...
    <td width="883" height="223" align="center" valign="middle"> <p>
    <?php
	 class Usuario
...
include ('conexion.php');
	...
	public function solicitar($ccodigo)
	 {	
	include ('conexion.php');
...
echo"<p>";	
echo  " NUMERO DE DOCUMENTO:$docu <br>";
  echo "CODIGO LIBRO:$ccodigo <br>";
}
  }
 $nuevo=new Usuario();
 $nuevo->Consultar($_POST["codigo"]);
 $nuevo->Solicitar($_POST["codigo"]);	
  ?> 
