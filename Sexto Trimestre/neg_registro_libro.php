...
<?php
	...
	class Libro 
	{
			...
			public function registrar($idLibro,$titulo,$autor,$editorial,$cantidad,$genero,$fechaPublicacion,$descripcionFisica,$fechaRegistro,$estadoPrestamo,$numero)
			{
				//insertar imagen
				...
				include('conexion.php');
					...
					if ($numero=='45n')
					{
						...
						mysqli_query($db,"INSERT INTO libro (idLibro,titulo,autor,editorial,cantidad,genero,fechaPublicacion,descripcionFisica,fechaRegistro,fk_id_EstadoPrestamo,imagen) VALUES ('$idLibro','$titulo','$autor','$editorial','$cantidad','$genero','$fechaPublicacion','$descripcionFisica','$fechaRegistro','$estadoPrestamo','$nombre')") or die (mysqli_error($db));
	...
	$nuevo =new Libro();
	$nuevo-> registrar($_POST["idLibro"],$_POST["titulo"],$_POST["autor"],$_POST["editorial"],$_POST["cantidad"],$_POST["genero"],$_POST["fechaPublicacion"],$_POST["descripcionFisica"],$_POST["fechaRegistro"],$_POST["estadoPrestamo"],$_POST["numero"]);
