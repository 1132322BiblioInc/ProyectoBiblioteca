...
<table width="1500" height="709" border="0" align="center" >
  <tr align="center" valign="top">
    <td height="313" colspan="3" ><iframe src="banner2.php" align="center" frameborder="0" scrolling="no" width="1902" height="185"> </iframe></td>
  </tr>
  <tr>
...
class Usuario
{
	...
	public function ConsultarLibroCodigo($ccodigo)
	{
...
public function ImprimirLibro($ccodigo)
{
	include ('conexion.php');
...
echo"</table>";
	...
	$nuevo=new Usuario();
 $nuevo->ConsultarLibroCodigo($_POST["codigo"]);
 $nuevo->ImprimirLibro($_POST["codigo"]);	
