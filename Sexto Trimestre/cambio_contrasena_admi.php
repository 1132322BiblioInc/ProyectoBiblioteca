...
<table width="1500" height="917" border="0" align="center" >
  ...
  <tr>
	...
	<center>
	  <form id="form1" name="form1" method="post" action="cambio_contrasena_admi2.php">
	    ...
	    <p>CONTRSEÑA ACTUAL
	      <br />
	      <label for=""></label>
          <input name="contrsena_actual" type="text" id="contrsena_actual" size="30" maxlength="30" />
          <br />
	      <br />
	      CONTRASEÑA NUEVA<br />
  ...
  <label for="confirmar_contrasena"></label>
	      <input name="confirmar_contrasena" type="text" id="confirmar_contrasena" size="30" maxlength="30" />
	      </p>
	    <p>
	      <label>
