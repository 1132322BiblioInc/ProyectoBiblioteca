...
<table width="1500" height="1491" border="0" align="center" >
  ...
  <tr>
    <td width="418" height="765" align="center" valign="middle"><table width="375" border="0">
      <tr>
        <td width="369"><img src="Imagen prueba/book.png" width="252" height="188" /></td>
      </tr>
      <tr>
    ...
    <td width="713" height="765" align="center" valign="middle">
	<center>
	  <table width="326" height="58" border="0" align="center">
        <tr>
          <td width="304" align="center" valign="middle" class="Estilo1 Estilo5">ACTUALIZACIÓN</td>
        </tr>
      </table>
	  <label><br />
      <br />
...
$nuevo=new Libro();
$nuevo->BuscarLibro($_POST["idLibro"]);
$nuevo->ImprimirLibro($_POST["idLibro"]);	
    ...
    <td width="343" height="765" align="center" valign="middle">
	<center>
	  <img src="img_slider6.png" alt="imagen de libro " width="307" height="437" />
	</center>   </td>
  </tr>
  <tr align="center" valign="top">
