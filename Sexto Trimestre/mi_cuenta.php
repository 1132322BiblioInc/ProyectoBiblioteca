...
<table width="1655" height="1535" border="0" align="center">
  <tr>
    ...
    <center>
      ...
      <table width="233" height="127" border="1">
        <tr>
          <td width="226"><a href="datos_personales.php" target="_parent"><button class="boton">DATOS PERSONALES</button></a></td>
        </tr>
        <tr>
          <td height="41"><a href="#" target="_parent"><button class="boton">DATOS GENERALES</button></a></td>
        </tr>
        <tr>
          <td height="46"><a href="cambio_contrasena_usuario.php" target="_parent"><button class="boton">CAMBIO CONTRASEÑA</button></a></td>
        </tr>
        </table>
