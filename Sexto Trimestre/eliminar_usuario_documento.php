...
<table width="1500" height="917" border="0" align="center" >
  ...
  <tr>
	...
	<center>
	  <form id="form1" name="form1" method="post" action="eliminar_usuario_documento2.php">
	    <table width="326" height="58" border="0" align="center">
          <tr>
            <td width="304" align="center" valign="middle" class="Estilo1 Estilo5 Estilo6">ELIMINAR USUARIO</td>
          </tr>
        </table>
	    <p>DOCUMENTO  DEL USUARIO<br />
          <input name="docu" type="text" id="docu" size="16" pattern="[0-9]+" placeholder="DIGITE EL CODIGO" required="required" />
          <br />
          <br />
