...
<table width="1500" height="917" border="0" align="center" >
  ...
  <tr>
	...
	<center>
	 ...
	 $ffechapres=$_POST["fechapres"];
	 $ffechaentre=$_POST["fechaentre"];
	 
	  mysqli_query($db,"INSERT INTO prestamo(codigo_libro,titulo_libro,documento_usuario,nombre_usuario,fecha_prestamo,fecha_entrega)         VALUES('$iidlibro','$ttitulo','$numero_de_documento','$nnombre','$ffechapres','$ffechaentre')")
	  or die (mysqli_error ($db));
	  echo"<br>";
	  echo "El prestamo fue exitoso<br>";
  ...
  /* 
   ...
   $sql1="SELECT * FROM prestamo WHERE documento_usuario ='$numero_de_documento'";
	...
	{ 
      ...
      echo"<td width=144 class=Estilo2 bgcolor=#569EAB></td>";
      ...
      echo"<td class=Estilo2 bgcolor=#569EAB><label for=textfield2></label>$iidlibro</td>";
      echo"<td class=Estilo2 bgcolor=#569EAB>TITULO DEL LIBRO</td>";
      echo"<td class=Estilo2 bgcolor=#569EAB><label for=textfield3></label>$ttitulo</td>";
      echo"</tr>";
      echo"<tr>";
      echo"<td class=Estilo2 bgcolor=#569EAB>DOCUMENTO USUARIO</td>";
      echo"<td class=Estilo2 bgcolor=#569EAB><label for=textfield5></label> $numero_de_documento</td>";
           
      echo"<td class=Estilo2 bgcolor=#569EAB>NOMBRE USUARIO</td>";
      echo"<td class=Estilo2 bgcolor=#569EAB><label for=textfield5></label>$nnombre</td>";
      echo"</tr>";
      echo"<tr>";
      echo"<td class=Estilo2 bgcolor=#569EAB>FECHA DE PRESTAMO</td>";
      echo"<td class=Estilo2 bgcolor=#569EAB><label for=textfield6></label>$ffechapres</td>";
      echo"<td class=Estilo2 bgcolor=#569EAB>FECHA ENTREGA</td>";
      echo"<td class=Estilo2 bgcolor=#569EAB><label for=textfield7></label> $ffechaentre</td>";
      echo"</tr>";
      echo"<tr bgcolor=#067184>";
