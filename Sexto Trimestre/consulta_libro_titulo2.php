...
<table width="1500" height="593" border="0" align="center" >
  <tr align="center" valign="top">
    <td height="197" colspan="3" ><iframe src="banner2.php" align="center" frameborder="0" scrolling="no" width="1902" height="185"> </iframe></td>
  </tr>
  <tr>
...
class usuario
{
       public function ConsultarLibroTitulo($ttitulo)
       {
	        include ('conexion.php');
	
	        $sql="SELECT * FROM libro WHERE titulo LIKE '$ttitulo%'";
    ...
    public function ImprimirLibro($ttitulo)
     {
		 include ('conexion.php');
...
$nuevo=new Usuario();
 $nuevo->ConsultarLibroTitulo($_POST["titulo"]);
 $nuevo->ImprimirLibro($_POST["titulo"]);	
