...
<table width="1500" height="600" border="0" align="center" >
  <tr align="center" valign="top">
    <td height="204" colspan="3" ><iframe src="banner2.php" align="center" frameborder="0" scrolling="no" width="1902" height="185"> </iframe></td>
  </tr>
  <tr>
    ...
    <td width="638" height="280" align="center" valign="middle">
      ...
      <form id="form1" name="form1" method="post" action="consulta_libro_genero2.php">
        <table width="488" border="1">
          <tr>
            <td width="203" class="Estilo2">Escriba el genero del libro a buscar</td>
            <td width="190"><label for="busc"></label>            <label for="color"></label>
              <label for="genero"></label>
              <input name="genero" type="text" id="genero" size="50" maxlength="60" /><label for="docum"></label></td>
            </tr>
          <tr>
            <td class="Estilo2">&nbsp;</td>
