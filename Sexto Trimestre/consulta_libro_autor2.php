...
{
	public function ConsutlarLibroAutor($AAutor)
	{
	 ...
	 $sql="SELECT * FROM libro WHERE autor LIKE '$AAutor%'";
	...
	public function ImprimirLibro($AAutor)
	{
...
echo"</table>";
 ...
 $nuevo=new Usuario();
 $nuevo->ConsutlarLibroAutor($_POST["Autor"]);
 $nuevo->ImprimirLibro($_POST["Autor"]);	
?>
