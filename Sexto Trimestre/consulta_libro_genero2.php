...
<table width="1500" height="580" border="0" align="center" >
  <tr align="center" valign="top">
    <td height="184" colspan="3" ><iframe src="banner2.php" align="center" frameborder="0" scrolling="no" width="1902" height="185"> </iframe></td>
  </tr>
  <tr>
...
class Usuario
{
     public function ConsultarLibroGenero( $ggenero)
     {
	     include ('conexion.php');
	
	 $sql="SELECT * FROM libro WHERE genero LIKE '$ggenero%'";
	  ...
	  public function ImprimirLibro($ggenero)
...
$nuevo=new Usuario();
 $nuevo->ConsultarLibroGenero($_POST["genero"]);
 $nuevo->ImprimirLibro($_POST["genero"]);			
