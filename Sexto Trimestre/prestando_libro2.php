  ...
  <tr>
	...
	<center>
	 ...
	 $ffechaentre=$_POST["fechaentre"];
	  ...
	  mysqli_query($db,"INSERT INTO prestamo(codigo_libro,titulo_libro,documento_usuario,nombre_usuario,fecha_prestamo,fecha_entrega)         VALUES('$ccodigo','$ttitulo','$ddocumento','$nnombre','$ffechapres','$ffechaentre')")
  ...
  /* 
   ...
   $sql1="SELECT * FROM prestamo WHERE documento_usuario ='$numero_de_documento'";
	...
	{ 
      ...
      echo"<td class=Estilo2 bgcolor=#569EAB><label for=textfield2></label>$ccodigo</td>";
      ...
      echo"<td class=Estilo2 bgcolor=#569EAB><label for=textfield5></label> $ddocumento</td>";
