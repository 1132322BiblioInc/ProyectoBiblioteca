...
<table width="1500" height="917" border="0" align="center" >
  ...
  <tr>
	...
	<center>
	  <form id="form1" name="form1" method="post" action="devolucion2.php">
	    <table width="326" height="58" border="0" align="center">
          <tr>
            <td width="304" align="center" valign="middle" class="Estilo1 Estilo5 Estilo6">BUSQUEDA PARA DEVOLUCION</td>
          </tr>
        </table>
